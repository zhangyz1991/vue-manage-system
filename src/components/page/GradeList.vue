    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 年级列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>
                <el-input v-model="query.name" placeholder="年级" class="handle-input mr10"></el-input>
            ...
            >
                ...
                <el-table-column prop="startDate" label="起始年月"></el-table-column>
                <el-table-column prop="endDate" label="期终年月"></el-table-column>
...
<script>
import { fetchData, deleteData} from '../../api/grade';
export default {
    name: 'gradetable',
    data() {
        return {
